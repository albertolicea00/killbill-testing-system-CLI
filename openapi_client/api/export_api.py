...
class ExportApi:
    ...
    def export_data_for_account(
        ...
        _param = self._export_data_for_account_serialize(
    ...
    @validate_call
    def export_data_for_account_without_preload_content(
        self,
        account_id: Annotated[str, Field(strict=True)],
        x_killbill_created_by: StrictStr,
        x_killbill_reason: Optional[StrictStr] = None,
    ...
    def _export_data_for_account_serialize(
        self,
        account_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/1.0/kb/export/{accountId}',
