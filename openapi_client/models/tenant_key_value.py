...
class TenantKeyValue(BaseModel):
    """
    TenantKeyValue
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["key", "values", "auditLogs"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of TenantKeyValue from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of TenantKeyValue from a dict"""
        if obj is None:
            return None
