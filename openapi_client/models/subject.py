...
class Subject(BaseModel):
    ...
    is_remembered: Optional[StrictBool] = Field(default=None, alias="isRemembered")
    session: Optional[Session] = None
    __properties: ClassVar[List[str]] = ["principal", "isAuthenticated", "isRemembered", "session"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "isRemembered": obj.get("isRemembered"),
