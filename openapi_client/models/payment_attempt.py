...
class PaymentAttempt(BaseModel):
    ...
    plugin_properties: Optional[List[PluginProperty]] = Field(default=None, alias="pluginProperties")
    audit_logs: Optional[List[AuditLog]] = Field(default=None, alias="auditLogs")
    __properties: ClassVar[List[str]] = ["accountId", "paymentMethodId", "paymentExternalKey", "transactionId", "transactionExternalKey", "transactionType", "effectiveDate", "stateName", "amount", "currency", "pluginName", "pluginProperties", "auditLogs"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PaymentAttempt from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in plugin_properties (list)
        _items = []
        if self.plugin_properties:
            for _item in self.plugin_properties:
                if _item:
                    _items.append(_item.to_dict())
            _dict['pluginProperties'] = _items
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of PaymentAttempt from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "pluginProperties": [PluginProperty.from_dict(_item) for _item in obj.get("pluginProperties")] if obj.get("pluginProperties") is not None else None,
