...
class AccountEmail(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["accountId", "email", "auditLogs"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AccountEmail from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of AccountEmail from a dict"""
        if obj is None:
            return None
