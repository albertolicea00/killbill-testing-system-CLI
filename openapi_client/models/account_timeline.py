...
class AccountTimeline(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["account", "bundles", "invoices", "payments"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AccountTimeline from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of AccountTimeline from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "bundles": [Bundle.from_dict(_item) for _item in obj.get("bundles")] if obj.get("bundles") is not None else None,
            "invoices": [Invoice.from_dict(_item) for _item in obj.get("invoices")] if obj.get("invoices") is not None else None,
            "payments": [InvoicePayment.from_dict(_item) for _item in obj.get("payments")] if obj.get("payments") is not None else None
        })
        return _obj
