...
class BundleTimeline(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["accountId", "bundleId", "externalKey", "events", "auditLogs"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of BundleTimeline from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of BundleTimeline from a dict"""
        if obj is None:
            return None
