...
class Bundle(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["accountId", "bundleId", "externalKey", "subscriptions", "timeline", "auditLogs"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "timeline": BundleTimeline.from_dict(obj.get("timeline")) if obj.get("timeline") is not None else None,
